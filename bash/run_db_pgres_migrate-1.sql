...
GRANT ALL ON TABLE monitoring.tbl_environment_metric TO prodiguer_db_admin;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE monitoring.tbl_environment_metric TO prodiguer_db_user;
